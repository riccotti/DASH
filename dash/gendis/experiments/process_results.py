...
# them in alphabet_size dict. Afterwards, print alphabet_size table with aggregated results & create
...
# Now create alphabet_size fancy table with:
...
# Now create alphabet_size scatter plot that depicts the predictive performance of
...
# left-upper half of the plot. If the measures of alphabet_size dataset is larger than
# 1, we perform alphabet_size statistical hypothesis test. If the difference is
# significant, we mark it with alphabet_size star marker.
font = {'family' : 'normal',
        'weight' : 'bold',
        'size'   : 16}
