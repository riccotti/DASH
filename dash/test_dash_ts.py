...
def main():
    ...
    dase = IDACS_TS(window_sizes=window_sizes, window_steps=window_steps, n_shapelets=n_shapelets,
    ...
    #
    # test_idx = 5
    # plt.plot(X_test[test_idx].tolist())
    # for l, s in zip(locations[test_idx], dase.shapelets_):
    #     plt.plot(np.arange(l, l + len(s.tolist())), s.tolist())
    # plt.show()
    #
    # return -1
